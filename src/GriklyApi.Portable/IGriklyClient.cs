...
namespace Grikly
{
    ...
    public interface IGriklyClient : IDisposable
    {
        ...
        /// <param name="token">The token.</param>
        /// <returns></returns>
        Task<GriklyHttpResponseMessage<AuthenticationModel>> Login(string email, string password,
        ...
        /// <param name="token">The token.</param>
        /// <returns></returns>
        Task<GriklyHttpResponseMessage> ResetPassword(string email, string code, string password, string confirmPassword,
            CancellationToken token);
