...
namespace GriklyApi.Models
{
    ...
    ///     The http response.
    /// </summary>
    //public class HttpResponse : GriklyHttpResponseMessage
    //{
    ...
    // <typeparam name="T">
    // </typeparam>
    //public class HttpResponse<T> : GriklyHttpResponseMessage<T>
    //{
    ...
    //     The response result.
    //     </param>
    //    public HttpResponse(GriklyHttpResponseMessage responseResult)
    //    {
    ...
    // </summary>
    //public interface GriklyHttpResponseMessage
    //{
    //    #region Public Properties
    ...
    // <typeparam name="T">
    // </typeparam>
    //public interface GriklyHttpResponseMessage<T> : GriklyHttpResponseMessage
    //{
    //    #region Public Properties
